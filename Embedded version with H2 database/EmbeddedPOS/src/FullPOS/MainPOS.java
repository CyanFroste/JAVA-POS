...
public class MainPOS extends javax.swing.JFrame {
    ...
    String lname;
    public MainPOS(String name) throws ClassNotFoundException {
        initComponents();        
        this.lname = name;
        user.setText(lname); 
        CategoryTableUpdate();
    ...
    private void initComponents() {
        ...
        printSR.setText("GENERATE SALES REPORT");
        ...
        printIndPS.setText("GENERATE INDIVIDUAL PRODUCT SALES REPORT");
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(printSR, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(printIndPS)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void editButtonCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonCatActionPerformed
        ...
        try{
            Class.forName ("org.h2.Driver");            Class.forName ("org.h2.Driver");            con = DriverManager.getConnection(URL,USER,PASS);
    ...
    @SuppressWarnings("unchecked")
    private void Category() throws ClassNotFoundException{        
        try{            
            Class.forName ("org.h2.Driver");            con = DriverManager.getConnection(URL,USER,PASS);
    ...
    private void CategoryTableUpdate() throws ClassNotFoundException{
        try{
            int ColumnCount;
            Class.forName ("org.h2.Driver");            con = DriverManager.getConnection(URL,USER,PASS);
            String sql = "SELECT * FROM category";
    ...
    private void CatalogTableUpdate() throws ClassNotFoundException{
        try{
            int ColumnCount;
            Class.forName ("org.h2.Driver");            con = DriverManager.getConnection(URL,USER,PASS);
    ...
    private void addButtonCatActionPerformed() throws ClassNotFoundException{
    ...
    private void deleteButtonCatActionPerformed() throws ClassNotFoundException{
        DefaultTableModel model = (DefaultTableModel)tableCategory.getModel();
        int SelectIndex = tableCategory.getSelectedRow();        
        int CID = Integer.parseInt(model.getValueAt(SelectIndex, 0).toString());        
    ...
    private void ClearCatalog() throws ClassNotFoundException{
        txtProduct.setText("");
    ...
    private void deleteButtonCatalogActionPerformed() throws ClassNotFoundException{
        DefaultTableModel model = (DefaultTableModel)tableCatalog.getModel();
        int SelectIndex = tableCatalog.getSelectedRow();        
        int PID = Integer.parseInt(model.getValueAt(SelectIndex, 0).toString());        
        int Choice = JOptionPane.showConfirmDialog(this, "Delete?","Warning", JOptionPane.YES_NO_OPTION);        
    ...
    private void GiveDiscount(String discount, float MRP){
    ...
    private void saleUpdate() throws ClassNotFoundException{
    ...
    private void deleteButtonUserActionPerformed() throws ClassNotFoundException{
    ...
    private void UserUpdate() throws ClassNotFoundException{        
        try{
            int ColumnCount;
            Class.forName ("org.h2.Driver");            con = DriverManager.getConnection(URL,USER,PASS);
    ...
    private void addButtonUserActionPerformed() throws ClassNotFoundException{
        String Username = txtUsername.getText();
