...
public class MainPOSuserLevel extends javax.swing.JFrame {
    ...
    String lname;
    public MainPOSuserLevel(String name) throws ClassNotFoundException {
        initComponents();
        this.lname = name;
        user.setText(lname);        
        CategoryTableUpdate();
    ...
    private void editButtonCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonCatActionPerformed
        ...
        try{
            ...
            Logger.getLogger(MainPOSuserLevel.class.getName()).log(Level.SEVERE, null, ex);
        }finally {
            try {
                if (con != null) {
                    con.close();
    ...
    private void invoiceButtonActionPerformed() throws ClassNotFoundException{
